              ...
              <div class="col-lg-4 mx-auto">
                ...
                <div class="card-body">
                  ...
                  <p class="card-description">
                    Input data mitra anda
                  </p>
                  <form action="{{ route('mitra.submit', ['id' => $user->id]) }}" method="POST">
              
                    @csrf
                    <div class="form-group">
                      <label for="NamaMitra">Nama Mitra</label>
                      <input type="text" class="form-control" name="NamaMitra" placeholder="Nama Mitra" required>
                    </div>
                    <div class="form-group">
